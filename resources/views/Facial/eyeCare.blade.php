            ...
            <nav class="navbar navbar-default cl-effect-5"  id="cl-effect-5">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="active scroll" href="#models"><span data-hover="Eye Care">Eye Care</span></a></li> 
...
@php
	...
	{
		if($product->p_cosmetic == 'Eye Cream')
		{
			$item1[$quantity1] = $product; 
			$quantity1 +=1;
		}
		if($product->p_cosmetic == 'Eye Serum')
		{
			$item2[$quantity2] = $product; 
			$quantity2 +=1;
		}
		if($product->p_cosmetic == 'Eye Mask')
		{
...
<div class="agileits-w3layouts-specials" id="services">
			<h3 style="padding-top: 20px;">Eye Care Services</h3>
			<!-- <span></span>
 -->				<div class="special-grids">
...
<!-- cart -->
	...
	<div class="cart">
		<div class="wrapper">
			...
			<footer>
				<div onclick="send()">
					<a class="checkout btn"><em>Total - $<span>0</span></em></a>
				</div>
...
<script type="text/javascript">
	function send()
	{
		var img = getCookie("inventoryId");
		var name = getCookie("productName");
		var quantity = getCookie("cookieQuantity");
		var total = getCookie("totalPrice");
        
        window.location.href = '/sendToAdmin/'+img+'/'+name+'/'+quantity+'/'+total+'';
	}
</script>
	<!-- //footer -->
