    ...
    <div class="row">
        ...
        @else
            @foreach($orders as $order)
                ...
                <div class="col-6 col-lg-6 name">
                    <h5>{{$order->time->format('h:00 A')}}</h5>
                </div>
                ...
                <div class="col-6 col-lg-6 check" data-target="#exampleModalLong{{$order->id}}" data-toggle="modal">
                    <h4>Cancel Order <input type="radio" name="myCheck"  onclick="unAccept('{{$order->id}}')"></h4>
                </div>

                <div class="col-6 col-lg-6 check right">
                    <h4>Accept Order <input type="radio" name="myCheck"  onclick="location.href='{{ url('/accept/'.$order->id) }}'"></h4>
                </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content p-2">
                                    ...
                                    <div class="modal-footer">
                                        <a href="/unAccept/{{ $order->id }}"><button type="button" class="btn btn-ok">OK</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
