        ...
        <div class="care">
            ...
            <div class="row">
                <div class="col-md-1 col-1 col-lg-1 col-sm-1">
                    <i class="fa fa-pencil-square-o" style="font-size:24px; float: left;padding-top: 32px" onclick="edit('{{$fact->id}}','{{$fact->fact}}','eyeEdit','eyeEditForm')">
                    </i>
                </div>
            ...
            <div class="row">
                <div class="col-md-1 col-1 col-lg-1 col-sm-1">
                    <div  style="font-size:24px; float: left;padding: 0px 32px 32px 23px">
                        <i class="fas fa-plus" style="border-color: black; border-style: solid; padding: 5px;" onclick="Add('eyeAdd','eyeAddForm')">
                        </i>
                    </div>
