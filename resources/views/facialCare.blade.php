		...
		<div class="agileits-w3layouts-specials" id="models">
			...
			<span></span>
				<div class="special-grids">
					<div class="col-md-6 special-left l-grids">
						<a href="/eye">
							<figure class="effect-bubba">
								<img src="images/eye-care.jpg" alt=""/>
								<figcaption>
									<h4>Eye Care</h4>
					...
					<div class="col-md-6 special-right">
						<div class="sp-wid">
							...
							<ul>
								<li>
									<p>Check the ingredients of the product you used for eye area.</p>
								</li>
								<li>
									<p>Check fine lines, hyperpigmentation (dark circles), puffiness and general concerns.</p>
								</li>
								<li>
									<p>Always be gentle.</p>
								</li>
								<li>
									<p>Sun protection is a must.</p>
								</li>
								<li>
									<p>Sleep, eat well, exercise, repeat.</p>
								</li>
							</ul>
				...
				<div class="where-spl">
					<div class="col-md-6 special-left l-grids">
						 <figure class="effect-bubba">
								<img src="images/neckCare.jpg" alt=""/>
								<figcaption>
									<h4>Neck Care</h4>
									<p>In sit amet sapien eros quibusdam et aut officiis debitis aut rerum Integer in tincidunt labore et dolore magna aliqua</p>													
								</figcaption>			
...
<!--services-->
	<div id="services" class="services">
		<!-- container -->
		<div class="container">
			<h3 class="title wow zoomInLeft animated" data-wow-delay=".5s">Facial Services</h3>
			<div class="services-row">
				<div class="col-md-4 services-grid services-grid1" style="width: 33.33%;">
				...
				<div class="col-md-4 services-grid services-grid2" style="width: 33.33%;">
