...
<div class="w3-banner-info-agile">
		<div class="slider w3layouts agileits">
			<ul class="rslides w3layouts agileits" id="slider">
				<li>
						<div class="layer w3layouts agileits-banner hairCare">
							<h3>Hair Care</h3>
            ...
            <nav class="navbar navbar-default cl-effect-5"  id="cl-effect-5">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="active scroll" href="#models"><span data-hover="Hair Care">Hair Care</span></a></li> 
                        <li><a class="scroll" href="#product"><span data-hover="Products">Products</span></a></li> 
...
<div class="agileits-w3layouts-specials" id="models">
	...
	<div class="special-grids">
		...
		<div class="col-md-12 special-right">
			<div class="l-wid">
				<h4>Hair Caring Methods</h4>
				<p>
...
@php
	...
	{
		if($product->p_cosmetic == 'Shampoo')
		{
			$item1[$quantity1] = $product; 
			$quantity1 +=1;
		}
		if($product->p_cosmetic == 'Conditioner')
		{
			$item2[$quantity2] = $product; 
			$quantity2 +=1;
		}
		if($product->p_cosmetic == 'Hair Serum')
		{
...
<!-- Hair products -->
<div class="agileits-w3layouts-specials" id="product">
	<h3>Hair Products</h3>
...
<div class="agileits-w3layouts-specials" id="services">
			<h3 style="padding-top: 20px;">Hair Services</h3>
			<!-- <span></span>
 -->				<div class="special-grids">
					...
					<div class="col-md-6 special-right">
						<div class="sp-wid">
							...
							<p>Hair creams are formulated specifically for the delicate skin around the Hair, so they tend to be thicker. ... Squinting and constant movement of the Hairs also hasten the appearance of lines and wrinkles, and fluids collect under the Hairs and cause puffiness and dark circles. Hair creams can address some of these issues.</p>
						</div>
					</div>
					<div class="clearfix"></div>
				</div>
				...
				<div class="where-spl">
					<div class="col-md-6 special-right l-left">
						<div class="l-wid">
							<h4>Aria Nail Bar</h4>
							<p>They are ligher than creams, and are designed to target things like fine lines, puffiness, and dark circles. Some are designed also to hydrate or firm the delicate skin around the Hairs. ... Our Hair serum is jam packed with results driven ingredients.</p>
						</div>
				...
				<div class="where-spl">
					...
					<div class="col-md-6 special-right">
						<div class="sp-wid">
							<h4>Mr.C Spa</h4>
							<p>Under-Hair masks typically look like comma-shaped patches and are infused with lightweight but potent serums packed with innovative ingredients like retinol, hyaluronic acid and ceramides designed to plump your skin and bust dark circles.</p>
						</div>
					</div>
					<div class="clearfix"></div>
				</div>
